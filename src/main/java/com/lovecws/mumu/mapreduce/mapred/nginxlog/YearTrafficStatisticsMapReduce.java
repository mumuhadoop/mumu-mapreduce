 ...
 */
public class YearTrafficStatisticsMapReduce {

    /**
     * mapper
     */
    public static class YearTrafficStatisticsMapper extends Mapper<LongWritable, Text, Text, Text> {
        @Override
     ...
     * reduce
     */
    public static class YearTrafficStatisticsReducer extends Reducer<Text, Text, Text, IntWritable> {
        @Override
